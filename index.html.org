            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col col-md-4 col-xl-2">
                        <a href="#reserveForm" role="button" class="btn btn-lg btn-info" data-toggle="tooltip" data-placement="bottom"
        ...
        <div class="container">
            ...
            <div class="row row-content align-items-center">
                ...
                <div class="col">
                    <div class="media">
                        <div class="media-body align-self-center">
                        <h3 class="text-sm-left">React Lake Campground</h3>
                        <p>Nestled in the foothills of the Chrome Mountains, this campground on the shores of the pristine React
                        Lake is a favorite for fly fishers.</p>
                        </div>
                        <img class="d-flex ml-3 img-thumbnail" src="img/react-lake-thumb.jpg" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-content align-items-center">
                <div class="col col-sm-10 mx-auto" >
                    <div class="card">
                        <h3 class="card-header text-white bg-info"> Reserve a Campsite</h3>
                        <div class="card-body">
                            <form  id= "reserveForm"action="">
                                <div class="row form-group">
                                    <label class="col-sm-6  col-form-label" for="numCampers">Number of Campers</label>
                                    <div class="col-sm-6">
                                        <select  class="col form-control" name="numCampers" id="numCampers" >
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input  class="col form-control" type="text" id="date" name="date" placeholder="mm//dd/yyyy">
